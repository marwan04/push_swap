...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/01 09:32:07 by malrifai          #+#    #+#             */
/*   Updated: 2024/10/19 16:24:24 by malrifai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

int	r_top(t_sawp_list *stack_a, int index, char *r, char *rr)
{
	int	op;
	int	nb_op;
	int	sign;
...
void	resolve_coherences(t_sawp_list *stack_a, t_sawp_list *stack_b,
		int index)
{
	int	dist;
...
void	resolve_num(t_sawp_list *stack_a, t_sawp_list *stack_b, int index,
		int stack_size)
{
	int	start;
	int	same;
...
int	get_median(t_sawp_list *stack)
{
	int	start;
	int	end;
		...
		int stack_size)
{
	...
	{
		resolve_num(stack_b, stack_a, get_best_op_index(stack_b, stack_a,
